...
# Parameters
# --------------------------
IMAGE_PATH = "/Users/maxkeune/Desktop/Uni Fächer/Symbolische Musikprogrammierung/Birdsong/Images/Birds7.jpg"
...
points = [(k.pt[0], k.pt[1]) for k in keypoints]
points = merge_close_points(points, MERGE_DISTANCE)

print("Birds detected after merging:", len(points))
if not points:
    raise RuntimeError("No birds detected. Check your image or blob parameters.")
